...
`trigger_eval_set.json` checks activation and non-activation. `maintenance_eval_set.json`
checks preservation, pruning, judgment space, risk gating, and regression behavior.
